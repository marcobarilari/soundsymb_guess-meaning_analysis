---
title: "Guess the meaning - Main Analysis with Native Accuracy"
author: "Marco Barilari, Minah Chang, Roberto Botini"
date: "4 March, 2022"
...
# Analyses for the group comparison using the native accuracy
...
### Compare the native and raw accuracy
...
(β = -0.04, SE = 0.15, z = -.0.24, p = .812, odds ratio = 0.96, LL = 0.72, UL = 1.30)

There is no significant difference between the performance of two groups across the symbolic categories 

(β =0.01, SE = 0.01, z =0.70, p = .487, odds ratio = 1.01, LL = 0.98, UL = 1.04)
