...
names(allData$language)

allData$language <-  as.character(allData$language)

allData <- subset(allData, language != "albanian")

allData <- subset(allData, language != "dutch")

allData <- subset(allData, language != "romanian")
